...
const createSnippet = () => {
    ...
    const handleSave = async () => {
        ...
        // strore the data in the database
        await db.runAsync(
            `INSERT INTO snippets (title, code_content, language, tags, screenshot_path)
   VALUES (?, ?, ?, ?, ?)`,
            [title, code, selectedLanguage, tags.join(","), savedScrrenshotPath]
        );
